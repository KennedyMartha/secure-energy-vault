...
type PowerUsageConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: PowerUsageConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class PowerUsage__factory extends ContractFactory {
  constructor(...args: PowerUsageConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): PowerUsage__factory {
    return super.connect(runner) as PowerUsage__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PowerUsageInterface {
    return new Interface(_abi) as PowerUsageInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PowerUsage {
    return new Contract(address, _abi, runner) as unknown as PowerUsage;
  }
}
